...
<main class="container">
  <div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    ...
    <?php if($video): ?>
      ...
      <source src="<?php echo e(URL::asset('uploads/'.$video->video)); ?>" id="video-mp4" type="video/mp4">   
      <source src="<?php echo e(URL::asset('uploads/'.$video->video)); ?>" id="video-ogg" type="video/ogg">   
      ...
      <p>Select quality</p>
      <div>
        <button class="btn btn-warning" onclick="changeVideo('1080p');" type="submit">1080p</button>
        <button class="btn btn-warning" onclick="changeVideo('720p');" type="submit">720p</button>
        <button class="btn btn-warning" onclick="changeVideo('360p');" type="submit">360p</button>
      </div>
      <hr />
    <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\galeri video\resources\views/videos/view.blade.php ENDPATH**/ ?>